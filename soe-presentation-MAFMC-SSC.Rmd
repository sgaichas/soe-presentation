...
subtitle: "Mid-Atlantic 2019<br /> with updates to EAFM Risk Assessment"
...
Recently revised policy guidance document<sup>2</sup> 

Completed inital risk assessment 2017<sup>3</sup>

SOE indicators to be used for annual risk assessment updates
]

.pull-right[
*MAFMC EAFM framework<sup>1</sup>*
![framework](images/Framework.png)

]

.footnote[
[1] https://www.frontiersin.org/articles/10.3389/fmars.2016.00105/full

[2] http://www.mafmc.org/s/EAFM-Doc-Revised-2019-02-08.pdf
...
???
Here we describe the relationships between major ecosystem components on the northeast shelf
...
* Atlantic mackerel stock above F/Fmsy and below B/Bmsy
...
* A decreasing trend in recreational fleet effort diversity and diversity of catch
...
## Challenge: Unprecedented ecosystem change

*Northeast US shelf is still among the fastest warming waters globally
*A more northerly Gulf Stream position is generally associated with warmer ocean temperature in the Northeast US shelf
...
---
## Comparing inshore and offshore surveys (I)
...
knitr::include_graphics("images/MAFMC_Fish_Condition_2019.jpg")
```
...
---
## Appendix: Common tern diet diversity
.pull-left[
