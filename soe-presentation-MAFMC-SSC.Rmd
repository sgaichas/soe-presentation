...
author: "Sarah Gaichas and Sean Hardison <br /> Ecosystem Dynamics and Assessment <br /> Northeast Fisheries Science Center"
output:
...
* A lower copepod size index means higher abundance of large copepods (<i>Calanus</i>)
...
knitr::include_graphics("images/sptable2019.png")
```
*Ecosystem level risk elements*
```{r ecotable, fig.align="center",out.width="95%"}
knitr::include_graphics("images/ecotable2019.png")
```
...
knitr::include_graphics("images/mgttable2019.png")
```
...
* [SOE Technical Documentation](https://noaa-edab.github.io/tech-dat)
