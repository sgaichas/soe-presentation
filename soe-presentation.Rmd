...
![mafmc-total](images/mafmc-total-landings.png)
...
NE:
* Social-ecological systems in New England are reliant on lobster (GOM) or scallop (GB) landings
* Crustaceans are thought to have a moderate-high climate vulnerability (OA, temperatures)
* Communities reliant on these fisheries are at high risk

MAB: 
* Similar story in MAB: many fishing communities are heavily reliant on shellfish species (mostly scallops)
* Aquaculture in the MAB is also dominated by shellfish (oysters). Virginia continues to lead the country in oyster production, with aquaculture in the region growing quickly. 
